...
namespace QuickSC.Runtime
{
    ...
    class QsFuncTypeInst : QsTypeInst
    {
        ...
        public QsFuncTypeInst(TypeValue.Func typeValue) { this.typeValue = typeValue; }
    ...
    {
        // 모든 모듈의 전역 변수
        public Dictionary<ModuleItemId, QsValue> globalValues { get; }
        List<IQsModule> modules;

        public QsDomainService()
        {
            globalValues = new Dictionary<ModuleItemId, QsValue>();
            modules = new List<IQsModule>();
        }

        public QsValue GetGlobalValue(ModuleItemId varId)
        {
        ...
        public QsFuncInst GetFuncInst(FuncValue funcValue)
        {
            // TODO: caching
        ...
        public QsTypeInst GetTypeInst(TypeValue typeValue)
        {
        ...
        public void InitGlobalValue(ModuleItemId varId, QsValue value)
        {
