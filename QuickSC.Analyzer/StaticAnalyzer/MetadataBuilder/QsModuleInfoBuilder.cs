...
namespace QuickSC.StaticAnalyzer
{
    public partial class QsModuleInfoBuilder
    {
        ...
        public QsModuleInfoBuilder(QsTypeExpEvaluator typeExpEvaluator)
        {
        ...
        public Result? BuildScript(string moduleName, IEnumerable<IModuleInfo> moduleInfos, Script script, IQsErrorCollector errorCollector)
        {
