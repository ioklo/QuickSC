...
");
            ...
            var expected = new QsForStmt(
                new QsExpForStmtInitializer(new QsCallExp(new QsIdentifierExp("f"), ImmutableArray<QsTypeExp>.Empty)),
        ...
        async Task TestParseExpStmtAsync()
        {
            ...
            var expected = new QsExpStmt(new QsBinaryOpExp(QsBinaryOpKind.Assign,
                ...
                new QsBinaryOpExp(QsBinaryOpKind.Multiply,
                    ...
                    new QsCallExp(new QsIdentifierExp("c"), ImmutableArray<QsTypeExp>.Empty, new QsIntLiteralExp(1)))));
